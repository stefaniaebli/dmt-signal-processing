...
def sequence_collapses(X,kX,collapses,dim_collapses):
    all_psi=[]
    all_phi=[]
    all_xq=[]
    all_boundaries=[]
...
def phipsi(X,kX,collapses,dim_collapses,signal,type_collapse='up'):
    ...
    all_psi,all_phi, all_boundaries, all_complexes,all_xq=sequence_collapses(X,kX,collapses=c,dim_collapses=d)
